package com.example.zhuwojia.scrollviewslidedemo.view;
...
public class MyScrollView extends ScrollView {
    ...
    public interface WindowFocusChanged {
        void OnWindowFousChanged(boolean hasFocus);
    }

    WindowFocusChanged changed;

    public void setWindowFocusChanged(WindowFocusChanged changed) {  //绑定
    ...
    public void onWindowFocusChanged(boolean hasFocus) {
        ...
        changed.OnWindowFousChanged(hasFocus);
    }
}
